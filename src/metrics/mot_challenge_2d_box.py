...
class MotChallenge2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'GT_FOLDER': os.path.join(code_path, '../../dataset/MOT17/images/train/'),  # Location of GT data
            #'GT_FOLDER': os.path.join(code_path, '../../dataset/MOT15/images/train/'),
            #Users/sganesh68/dataset/MOT15/images/train
            #/mnt/batch/tasks/shared/LS_root/mounts/clusters/emo-experiment/code/Users/sganesh68/efficient-object-tracking/src/data/gt/mot_challenge/
            #'TRACKERS_FOLDER': os.path.join(code_path, 'data/trackers/mot_challenge/'),  # Trackers location
            #Users/sganesh68/dataset/MOT15/images/results/MOT15_test_samplevideo_val_mot15_Dec5
            'TRACKERS_FOLDER': os.path.join(code_path, '../../dataset/MOT17/images/results/'),  # Trackers location
            #'TRACKERS_FOLDER': os.path.join(code_path, '../../dataset/MOT15/images/results/'),
            'OUTPUT_FOLDER': None,  # Where to save eval results (if None, same as TRACKERS_FOLDER)
            #'TRACKERS_TO_EVAL': ['MOT17_val_mot17_Feb22_mandskip6'],  # Filenames of trackers to eval (if None, all in folder)
            'TRACKERS_TO_EVAL': ['MOT15_val_mot17_Feb23_mandskip_adap24'],
            ...
            #'TUD-Campus': None,
            #'TUD-Stadtmitte': None,
            #'Venice-2': None}, #None,  # If not None, directly specify sequences to eval and their number of timesteps'
            'SEQ_INFO': {'MOT17-02-SDP': None,
            'MOT17-04-SDP': None,
            'MOT17-05-SDP': None,
            'MOT17-09-SDP': None,
            'MOT17-10-SDP': None,
            'MOT17-11-SDP': None,
            'MOT17-13-SDP': None}, #None,  # If not None, directly specify sequences to eval and their number of timesteps
